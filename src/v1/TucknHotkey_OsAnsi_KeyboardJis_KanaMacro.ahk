...
global gProfile := "os-ansi_keyboard-jis_kana-macro"
global gLayerProfile := "os-ansi_keyboard-jis"
...
gRuleMap["Select|Quote"] := {id: "select.jis_colon", layer: "Select", code: "Quote", action: "SendShiftQuoteCode", note: ""}
...
gRuleMap["Nav|Quote"] := {id: "nav.jis_colon", layer: "Nav", code: "Quote", action: "SendBackquoteCode", note: "quote系に寄せるため ` (Backquote) を割り当てる"}
...
gRuleMap["NavSelect|BracketLeft"] := {id: "navselect.jis_at", layer: "NavSelect", code: "BracketLeft", action: "SendShiftMinusCode", note: "_"}
...
gRuleMap["NavSelect|Quote"] := {id: "navselect.jis_colon", layer: "NavSelect", code: "Quote", action: "SendShiftBackquoteCode", note: " ~ (Childa)"}
...
global gOverrides := []
gOverrides.Push({id: "override-set.os-ansi_keyboard-jis_kana:override.nav.comma.kana", override_set: "override-set.os-ansi_keyboard-jis_kana", target_layer_profile: "os-ansi_keyboard-jis", target_rule_id: "nav.comma", action: "SendBracketRightCode", note: " [ を割り当てたが、かな入力時はNavとの組み合わせでここに「゜（半濁点）」を割り当てたい。「゜」はANSI配列だと BracketRight", when_ime_state: "on", when_japanese_input_mode: "any", when_os_layout: "os-ansi", when_app: "any"})
gOverrides.Push({id: "override-set.os-ansi_keyboard-jis_kana:override.nav.period.kana", override_set: "override-set.os-ansi_keyboard-jis_kana", target_layer_profile: "os-ansi_keyboard-jis", target_rule_id: "nav.period", action: "SendBackslashCode", note: " ] を割り当てたが、かな入力時はNavとの組み合わせでここに「む」を割り当てたい。ANSI配列だと「む」は Backslash", when_ime_state: "on", when_japanese_input_mode: "any", when_os_layout: "os-ansi", when_app: "any"})
gOverrides.Push({id: "override-set.os-ansi_keyboard-jis_kana:override.nav.slash.kana", override_set: "override-set.os-ansi_keyboard-jis_kana", target_layer_profile: "os-ansi_keyboard-jis", target_rule_id: "nav.slash", action: "SendBackquoteCode", note: "os-ansi では IntlRo を送れないため、Nav+Slash は通常時に Backslash を送るようlayerでリマップしているが、かな入力時に支障になるため、101/102 設定で「ろ」を出せるように Backquote に差し替える。", when_ime_state: "on", when_japanese_input_mode: "any", when_os_layout: "os-ansi", when_app: "any"})
gOverrides.Push({id: "override-set.os-ansi_keyboard-jis_kana:override.navselect.keyq", override_set: "override-set.os-ansi_keyboard-jis_kana", target_layer_profile: "os-ansi_keyboard-jis", target_rule_id: "navselect.keyq", action: "InsertFullWidthExclamation", note: "！（全角の感嘆符）を出力", when_ime_state: "on", when_japanese_input_mode: "any", when_os_layout: "os-ansi", when_app: "any"})
gOverrides.Push({id: "override-set.os-ansi_keyboard-jis_kana:override.navselect.keyw", override_set: "override-set.os-ansi_keyboard-jis_kana", target_layer_profile: "os-ansi_keyboard-jis", target_rule_id: "navselect.keyw", action: "InsertEllipsis", note: "…（三点リーダ）を出力", when_ime_state: "on", when_japanese_input_mode: "any", when_os_layout: "os-ansi", when_app: "any"})
gOverrides.Push({id: "override-set.os-ansi_keyboard-jis_kana:override.navselect.jis_colon", override_set: "override-set.os-ansi_keyboard-jis_kana", target_layer_profile: "os-ansi_keyboard-jis", target_rule_id: "navselect.jis_colon", action: "InsertFullWidthTilde", note: "～（全角の破線）を出力", when_ime_state: "on", when_japanese_input_mode: "any", when_os_layout: "os-ansi", when_app: "any"})
gOverrides.Push({id: "override-set.os-ansi_keyboard-jis_kana:override.navselect.keyz", override_set: "override-set.os-ansi_keyboard-jis_kana", target_layer_profile: "os-ansi_keyboard-jis", target_rule_id: "navselect.keyz", action: "InsertFullWidthPlus", note: "＋（全角のプラス）を出力", when_ime_state: "on", when_japanese_input_mode: "any", when_os_layout: "os-ansi", when_app: "any"})
gOverrides.Push({id: "override-set.os-ansi_keyboard-jis_kana:override.navselect.keyslash", override_set: "override-set.os-ansi_keyboard-jis_kana", target_layer_profile: "os-ansi_keyboard-jis", target_rule_id: "navselect.slash", action: "InsertFullWidthQuestionMark", note: "？（全角の疑問符）を出力", when_ime_state: "on", when_japanese_input_mode: "any", when_os_layout: "os-ansi", when_app: "any"})
