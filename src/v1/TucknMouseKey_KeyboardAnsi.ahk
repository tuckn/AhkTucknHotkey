...
global gProfile := "mouse-set.keyboard-ansi_nonedit-edit-gesture"
global gMouseSet := "mouse-set.keyboard-ansi_nonedit-edit-gesture"
...
gActions["SelectLeft"] := {kind: "shortcut", mods: ["Shift"], key: "ArrowLeft", description: ""}
gActions["SelectDown"] := {kind: "shortcut", mods: ["Shift"], key: "ArrowDown", description: ""}
gActions["SelectUp"] := {kind: "shortcut", mods: ["Shift"], key: "ArrowUp", description: ""}
gActions["SelectRight"] := {kind: "shortcut", mods: ["Shift"], key: "ArrowRight", description: ""}
...
gMouseBindings.Push({id: "noneditselect.keye", section: "NonEditSelect", trigger_role: "NonEdit", input_kind: "code", input_value: "KeyE", mods: "", action: "SelectUp", note: "F10 + Select + e で Shift+↑", specificity: 1, requirements: [{kind: "keyboard_role", keyboard_role: "Select"}]})
gMouseBindings.Push({id: "noneditselect.keys", section: "NonEditSelect", trigger_role: "NonEdit", input_kind: "code", input_value: "KeyS", mods: "", action: "SelectLeft", note: "F10 + Select + s で Shift+←", specificity: 1, requirements: [{kind: "keyboard_role", keyboard_role: "Select"}]})
gMouseBindings.Push({id: "noneditselect.keyd", section: "NonEditSelect", trigger_role: "NonEdit", input_kind: "code", input_value: "KeyD", mods: "", action: "SelectDown", note: "F10 + Select + d で Shift+↓", specificity: 1, requirements: [{kind: "keyboard_role", keyboard_role: "Select"}]})
gMouseBindings.Push({id: "noneditselect.keyf", section: "NonEditSelect", trigger_role: "NonEdit", input_kind: "code", input_value: "KeyF", mods: "", action: "SelectRight", note: "F10 + Select + f で Shift+→", specificity: 1, requirements: [{kind: "keyboard_role", keyboard_role: "Select"}]})
...
gMouseKeyboardRoleHotkeys["Select"] := "LAlt"
