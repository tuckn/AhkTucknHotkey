...
global gProfile := "os-ansi_keyboard-ansi_kana-macro"
global gLayerProfile := "os-ansi_keyboard-ansi"
global gKeyboardProfile := "keyboard-ansi"
global gOsLayout := "os-ansi"
...
global gSelectTriggerCode := "AltLeft"
global gNavTriggerCode := "AltRight"
...
global gLayerTriggerSuppressUpSequence := "{vkA4sc038 up}{vkA5sc138 up}"
global gActions := {}
...
global gOverrides := []
gOverrides.Push({id: "override-set.os-ansi_keyboard-ansi_kana:override.nav.comma.kana", override_set: "override-set.os-ansi_keyboard-ansi_kana", target_layer_profile: "os-ansi_keyboard-ansi", target_rule_id: "nav.comma", action: "SendBracketRightCode", note: " [ を割り当てたが、かな入力時はNavとの組み合わせでここに「゜（半濁点）」を割り当てたい。これはANSI配列だと BracketRight", when_ime_state: "on", when_japanese_input_mode: "any", when_os_layout: "os-ansi", when_app: "any"})
gOverrides.Push({id: "override-set.os-ansi_keyboard-ansi_kana:override.nav.period.kana", override_set: "override-set.os-ansi_keyboard-ansi_kana", target_layer_profile: "os-ansi_keyboard-ansi", target_rule_id: "nav.period", action: "SendBackslashCode", note: " ] を割り当てたが、かな入力時はNavとの組み合わせでここに「む」を割り当てたい。これはANSI配列だと Backslash", when_ime_state: "on", when_japanese_input_mode: "any", when_os_layout: "os-ansi", when_app: "any"})
gOverrides.Push({id: "override-set.os-ansi_keyboard-ansi_kana:override.nav.slash.kana", override_set: "override-set.os-ansi_keyboard-ansi_kana", target_layer_profile: "os-ansi_keyboard-ansi", target_rule_id: "nav.slash", action: "SendBackquoteCode", note: "os-ansi では IntlRo を送れないため、Nav+Slash は通常時に Backslash を送るようlayerでリマップしている。しかし、かな入力時に支障になるため、101/102 設定で「ろ」を出せるように Backquote に差し替える。", when_ime_state: "on", when_japanese_input_mode: "any", when_os_layout: "os-ansi", when_app: "any"})
gOverrides.Push({id: "override-set.os-ansi_keyboard-ansi_kana:override.navselect.keyq", override_set: "override-set.os-ansi_keyboard-ansi_kana", target_layer_profile: "os-ansi_keyboard-ansi", target_rule_id: "navselect.keyq", action: "InsertFullWidthExclamation", note: "！（全角の感嘆符）を出力", when_ime_state: "on", when_japanese_input_mode: "any", when_os_layout: "os-ansi", when_app: "any"})
gOverrides.Push({id: "override-set.os-ansi_keyboard-ansi_kana:override.navselect.keyw", override_set: "override-set.os-ansi_keyboard-ansi_kana", target_layer_profile: "os-ansi_keyboard-ansi", target_rule_id: "navselect.keyw", action: "InsertEllipsis", note: "…（三点リーダ）を出力", when_ime_state: "on", when_japanese_input_mode: "any", when_os_layout: "os-ansi", when_app: "any"})
gOverrides.Push({id: "override-set.os-ansi_keyboard-ansi_kana:override.navselect.quote", override_set: "override-set.os-ansi_keyboard-ansi_kana", target_layer_profile: "os-ansi_keyboard-ansi", target_rule_id: "navselect.quote", action: "InsertFullWidthTilde", note: "～（全角の破線）を出力", when_ime_state: "on", when_japanese_input_mode: "any", when_os_layout: "os-ansi", when_app: "any"})
gOverrides.Push({id: "override-set.os-ansi_keyboard-ansi_kana:override.navselect.keyz", override_set: "override-set.os-ansi_keyboard-ansi_kana", target_layer_profile: "os-ansi_keyboard-ansi", target_rule_id: "navselect.keyz", action: "InsertFullWidthPlus", note: "＋（全角のプラス）を出力", when_ime_state: "on", when_japanese_input_mode: "any", when_os_layout: "os-ansi", when_app: "any"})
gOverrides.Push({id: "override-set.os-ansi_keyboard-ansi_kana:override.navselect.keyslash", override_set: "override-set.os-ansi_keyboard-ansi_kana", target_layer_profile: "os-ansi_keyboard-ansi", target_rule_id: "navselect.slash", action: "InsertFullWidthQuestionMark", note: "？（全角の疑問符）を出力", when_ime_state: "on", when_japanese_input_mode: "any", when_os_layout: "os-ansi", when_app: "any"})

global gChordBindings := []
gChordBindings.Push({id: "macroselect.keyd", chord_set: "chord-set.keyboard-ansi_macro", context: "MacroSelect", code: "KeyD", action: "PasteCurrentDateIso8601ExtendedLocal", note: "ISO 8601 拡張形式の日付文字列を返す（現在日付） 例: 2025-12-17", specificity: 3, requirements: [{kind: "trigger_role", trigger_role: "Nav"}, {kind: "trigger_role", trigger_role: "Select"}, {kind: "code", code: "KeyM"}]})
gChordBindings.Push({id: "macroselect.keyf", chord_set: "chord-set.keyboard-ansi_macro", context: "MacroSelect", code: "KeyF", action: "PasteCurrentDateTimeIso8601ExtendedLocal", note: "ISO 8601 拡張形式文字列を返す（現在時刻） 例: 2025-12-17T06:50:49+09:00", specificity: 3, requirements: [{kind: "trigger_role", trigger_role: "Nav"}, {kind: "trigger_role", trigger_role: "Select"}, {kind: "code", code: "KeyM"}]})
gChordBindings.Push({id: "macro.keyd", chord_set: "chord-set.keyboard-ansi_macro", context: "Macro", code: "KeyD", action: "PasteCurrentDateIso8601BasicLocal", note: "ISO 8601 基本形式の日付文字列を返す（現在日付） 例: 20251217", specificity: 2, requirements: [{kind: "trigger_role", trigger_role: "Nav"}, {kind: "code", code: "KeyM"}]})
gChordBindings.Push({id: "macro.keyf", chord_set: "chord-set.keyboard-ansi_macro", context: "Macro", code: "KeyF", action: "PasteCurrentDateTimeIso8601BasicLocal", note: "ISO 8601 基本形式文字列を返す（現在時刻） 例: 20251217T065049+0900", specificity: 2, requirements: [{kind: "trigger_role", trigger_role: "Nav"}, {kind: "code", code: "KeyM"}]})
gChordBindings.Push({id: "macro.keyh", chord_set: "chord-set.keyboard-ansi_macro", context: "Macro", code: "KeyH", action: "ShowPreviousView", note: "対象アプリごとに前の表示対象へ切り替える。ブラウザは前のタブ", specificity: 2, requirements: [{kind: "trigger_role", trigger_role: "Nav"}, {kind: "code", code: "KeyM"}]})
gChordBindings.Push({id: "macro.keyl", chord_set: "chord-set.keyboard-ansi_macro", context: "Macro", code: "KeyL", action: "ShowNextView", note: "対象アプリごとに次の表示対象へ切り替える。ブラウザは次のタブ", specificity: 2, requirements: [{kind: "trigger_role", trigger_role: "Nav"}, {kind: "code", code: "KeyM"}]})
gChordBindings.Push({id: "macro.keyc", chord_set: "chord-set.keyboard-ansi_macro", context: "Macro", code: "KeyC", action: "RunClipboardTool", note: "ローカル設定で指定したクリップボードツールを起動する", specificity: 2, requirements: [{kind: "trigger_role", trigger_role: "Nav"}, {kind: "code", code: "KeyM"}]})
gChordBindings.Push({id: "macro.keyv", chord_set: "chord-set.keyboard-ansi_macro", context: "Macro", code: "KeyV", action: "PasteClipboardAsPlainText", note: "クリップボードの内容をプレーンテキストとして貼り付ける", specificity: 2, requirements: [{kind: "trigger_role", trigger_role: "Nav"}, {kind: "code", code: "KeyM"}]})
